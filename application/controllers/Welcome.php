...
class Welcome extends CI_Controller {
	...
	{
		$prestasi		= $this->_getPrestasi()->row();
		...
		$this->pdftc->Text(15,100, 'Jangka Waktu Penilaian',false,false,true,0,0, 'C');
		$this->pdftc->Text(15,105, '01 Januari '.$prestasi->tahun.' s/d 31 Desember '.$prestasi->tahun,false,false,true,0,0, 'C');
		...
		$this->pdftc->Text(15,240, 'KANTOR REGIONAL XI BKN',false,false,true,0,0, 'C');
        ...
        foreach($skp_tahunan->result() as $val)
		{
			...
			<tr style="font-weight:bold;">
				...
				<td width="230" rowspan="2" align="center">III. KEGIATAN TUGAS JABATAN</td>
...
EOD;
		...
		$this->pdftc->Text(225,35, 'JANGKA WAKTU PENILAIAN',false,false,true,0,0, 'L');
		$this->pdftc->Text(225,39, 'BULAN :  Januari s/d Desember '.$prestasi->tahun,false,false,true,0,0, 'L');
...
WHERE a.tahun='2019' AND a.nilai_skp != 0
